...
<style>
    ...
    .slides-bbox .swiper-slide a {align-items: center;display: flex;text-align: center;justify-content: center;height: 100%;background: rgba(0,0,0,0.31);}
</style>

<div class="slides-bbox slides-input-1topFlash">
...
<script>
jQuery(function () {
    window.setTimeout(function () { Levme.swiper('1topFlash'); }, 100);
});
</script>
