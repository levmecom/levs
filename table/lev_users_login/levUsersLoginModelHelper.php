 ...
 *
 * 项目：/levs  -  $  - levUsersLoginModelHelper.php
 *
 * 作者：{{AUTO GENERATE}}
 */
...
class BaseLevUsersLoginModelMiddle extends BaseLevUsersLoginModel
{
    ...
    public static function headerHtm()
    {
        ...
        //return '<tips class="gray inblk scale8">自定义headerHtm：文件位置：'.__DIR__ . '/levUsersLoginModelHelper.php'.'</tips>';
    }
...
class levUsersLoginModelHelper extends BaseLevUsersLoginModelMiddle {
