...
use modules\levs\table\lev_users_login\levUsersLoginModelHelper;
...
class BaseAdminUsers extends Controllerv
{

    public static $controllerName = 'modules\levs\controllers\AdminUsersController';

    public static $Model = '\modules\levs\table\lev_users_login\levUsersLoginModelHelper';
    public static $ModelSelf = '\modules\levs\table\form\Form_lev_users_login\Form_lev_users_login';
    ...
    public static function adminop() {
        if ($adminop = Lev::GPv('adminop')) {
            ...
            if (($tips = levUsersLoginModelHelper::adminop($adminop)) !== null) {
    ...
    public static function actionIndex()
    {
        ...
        $allColumns = levUsersLoginModelHelper::allColumns();

        Lev::$app['title'] = '登陆用户 管理';
        ...
        $limit = static::$limit;
        $pages = levUsersLoginModelHelper::pageButtons($where?:1, $limit, $order);
    ...
    public static function actionView() {
        ...
        $info = levUsersLoginModelHelper::findOne(['id'=>$viewid]);
    ...
    public static function actionForm() {
        ...
        //$inputs = levUsersLoginModelHelper::inputs();
    ...
    public static function formatSelectColumn($columnKey, $val) {
        ...
        static::$SelectColumns[$columnKey] = method_exists('modules\levs\controllers\AdminUsersController', $method = 'col_'.$columnKey) ? static::$method() : [];
    ...
    /**
     * <tips class="gray inblk scale8">自定义headerViewHtm：文件位置：'.__DIR__ . '/BaseAdminUsers.php'.'</tips>
     * @return string
     */
    ...
    public static function headerHtm() {
        return !Lev::isDeveloper(Lev::$app['iden']) ? '' :
            '<tips class="gray inblk scale8">自定义headerHtm：文件位置：'.__DIR__ . '/AdminUsersController.php'.'</tips>';
    }
