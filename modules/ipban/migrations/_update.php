...
namespace modules\levs\modules\ipban\migrations;
...
class _update extends Migrationv
{
    ...
    public static function updateTableSchema() {
        //defined('ACTION_INSTALL') || define('ACTION_INSTALL', 1);
        _install::createTablesIfNotExists();

//        $sql = "ALTER TABLE `{{%ipban_record}}` ADD `pagename` varchar(150) NOT NULL DEFAULT '' COMMENT '页面标识' AFTER `id`; ";
//        dbHelper::existsField('{{%ipban_record}}', 'pagename') || dbHelper::executeSql($sql);
