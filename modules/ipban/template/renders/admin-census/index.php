...
<div class="page page-admin gen-page-admin">
    ...
    <div class="page-content gen-page-content">
        <?php echo AdminCensusController::headerHtm()?>
        ...
        <div class="card data-listb gen-list">
            <div class="data-xtable gen-tab">
                <table><thead><tr>
                    ...
                    <?php $v = AdminCensusController::formatListsv($_sv, $pages['lists']);?>
                        <tr>
                        ...
                        <?php endforeach;?>
                            <td class="opt-btn-box1">
                                <div class="buttons-row scale6 transl avd-box1">
                                    ...
                                    <?php endif;?>
                                    <?php if (AdminCensusController::$copyOneBtn):?>
                                        <a class="button button-fill color-yellow is_ajax_a admin-copy-btnv" href="<?=AdminCensusController::copyOneUrl($_pk)?>" title="复制这条数据">
                                            复制
                                        </a>
                                    <?php endif;?>
                                ...
                                <div class="buttons-row scale6 transl opt-box1">
                                    <?=AdminCensusController::optButtons($_sv)?>
                                </div>
                            </td>
                ...
                <div class="card-footer cf-c-box">
                    <div class="ft-btn-box"><?php echo AdminCensusController::cardFooterButtons()?></div>
                    <div class="paging-box"><?php echo $pages['pages']?></div>
                </div>
            </div>
        </div>

        <?php echo AdminCensusController::footerHtm()?>
    </div>
