...
class BaseAdminRecord extends Controllerv
{

    public static $controllerName = 'modules\levs\modules\ipban\controllers\AdminRecordController';

    public static $Model = '\modules\levs\modules\ipban\table\ipban_record\ipbanRecordModelHelper';
    public static $ModelSelf = '\modules\levs\modules\ipban\table\form\Form_ipban_record\Form_ipban_record';
    ...
    public static function adminop() {
        if ($adminop = Lev::GPv('adminop')) {
            ...
            if (($tips = ipbanRecordModelHelper::adminop($adminop)) !== null) {
    ...
    public static function actionIndex()
    {
        ...
        $allColumns = ipbanRecordModelHelper::allColumns();

        Lev::$app['title'] = 'IP访问记录 管理';
        ...
        $limit = static::$limit;
        $pages = ipbanRecordModelHelper::pageButtons($where?:1, $limit, $order);
    ...
    public static function actionView() {
        ...
        $info = ipbanRecordModelHelper::findOne(['id'=>$viewid]);
    ...
    public static function actionForm() {
        ...
        //$inputs = ipbanRecordModelHelper::inputs();
    ...
    public static function formatSelectColumn($columnKey, $val) {
        ...
        static::$SelectColumns[$columnKey] = method_exists('modules\levs\modules\ipban\controllers\AdminRecordController', $method = 'col_'.$columnKey) ? static::$method() : [];
    ...
    /**
     * <tips class="gray inblk scale8">自定义headerViewHtm：文件位置：'.__DIR__ . '/BaseAdminRecord.php'.'</tips>
     * @return string
     */
    ...
    public static function headerHtm() {
        return !Lev::isDeveloper(Lev::$app['iden']) ? '' :
            '<tips class="gray inblk scale8">自定义headerHtm：文件位置：'.__DIR__ . '/AdminRecordController.php'.'</tips>';
    }
