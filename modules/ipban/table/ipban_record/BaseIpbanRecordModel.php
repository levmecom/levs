 ...
 *
 * 项目：/ipban  -  $  - BaseIpbanRecordModel.php
 *
 * 作者：{{AUTO GENERATE}}
 */
...
class BaseIpbanRecordModel extends SubModelv
{

    public static $tableName = '{{%ipban_record}}';
    ...
    public static function headerHtm() {
        return !Lev::isDeveloper(Lev::$app['iden']) ? '' :
            '<tips class="gray inblk scale8">自定义headerHtm：文件位置：'.__DIR__ . '/ipbanRecordModelHelper.php'.'</tips>';
    }
