 ...
 *
 * 创建时间：2021-11-25 00:02:50
 *
 * 项目：/ipban  -  $  - ipbanRecordModelHelper.php
 *
 * 作者：{{AUTO GENERATE}}
 */
...
namespace modules\levs\modules\ipban\table\ipban_record;

use Lev;

!defined('INLEV') && exit('Access Denied LEV');

class BaseIpbanRecordModelMiddle extends BaseIpbanRecordModel
{
    ...
    public static function headerHtm()
    {
        ...
        //return '<tips class="gray inblk scale8">自定义headerHtm：文件位置：'.__DIR__ . '/ipbanRecordModelHelper.php'.'</tips>';
    }
...
class ipbanRecordModelHelper extends BaseIpbanRecordModelMiddle {
