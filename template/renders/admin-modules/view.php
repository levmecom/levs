...
$_pk = $info['id'];
$_sv = $info;
$v = AdminModulesController::formatListsv($_sv, [$_sv]);
        ...
        <div class="card">
            <div class="card-header" style="justify-content: space-around">
                ...
                <?php if ($addurl):?>
                    ...
                    <a class="button button-fill color-red" href="<?=Lev::toReRoute([AdminModulesController::$tmpPath.'/form', 'opid'=>$_pk, 'modelall'=>1])?>">
                        源编辑
                    </a>
                <?php endif;?>
                <?php if ($trash):?>
